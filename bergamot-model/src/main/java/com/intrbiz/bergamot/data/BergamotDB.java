...
public abstract class BergamotDB extends DatabaseAdapter
{
    ...
    static
    {
        DataManager.getInstance().registerDatabaseAdapter(BergamotDB.class, DatabaseAdapterCompiler.defaultPGSQLCompiler().compileAdapterFactory(BergamotDB.class));
    }
    ...
    public abstract List<Host> listHostsInPool(@SQLParam(value = "pool") int pool);
