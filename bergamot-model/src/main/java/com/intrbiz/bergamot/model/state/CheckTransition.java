...
public class CheckTransition extends BergamotObject<CheckTransitionMO>
{
    ...
    public CheckTransition(UUID checkId, Timestamp appliedAt, boolean stateChange, boolean hardChange, boolean alert, boolean recovery, CheckState previous, CheckState next)
    {
        super();
