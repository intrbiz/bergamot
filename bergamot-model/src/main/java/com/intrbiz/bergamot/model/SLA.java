...
@SQLTable(schema = BergamotDB.class, name = "sla", since = @SQLVersion({4, 0, 0}))
public class SLA extends BergamotObject<SLAMO>
{
    ...
    @SQLColumn(index = 3, name = "name", since = @SQLVersion({4, 0, 0}))
    private String name;
    
    @SQLColumn(index = 4, name = "summary", since = @SQLVersion({4, 0, 0}))
    private String summary;
    
    @SQLColumn(index = 5, name = "description", since = @SQLVersion({4, 0, 0}))
    private String description;
    
    @SQLColumn(index = 6, name = "target", since = @SQLVersion({4, 0, 0}))
