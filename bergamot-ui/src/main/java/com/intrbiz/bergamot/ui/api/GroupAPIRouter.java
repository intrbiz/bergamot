...
public class GroupAPIRouter extends Router<BergamotApp>
{
    ...
    {
        return this.app().getBergamot().getObjectStore().getGroups().stream().map(Group::toStubMO).collect(Collectors.toList());
    }
    ...
    {
        return Util.nullable(this.app().getBergamot().getObjectStore().lookupGroup(name), Group::toMO);
    }
    ...
    {
        return Util.nullable(this.app().getBergamot().getObjectStore().lookupGroup(name), (e)->{return e.getChildren().stream().map(Group::toMO).collect(Collectors.toList());});
    }
    ...
    {
        return Util.nullable(this.app().getBergamot().getObjectStore().lookupGroup(name), (e)->{return e.getChecks().stream().map(Check::toMO).collect(Collectors.toList());});
    }
}
