...
@XmlType(name = "bergamot-daemon")
@XmlRootElement(name = "bergamot-daemon")
public class BergamotDaemonCfg extends Configuration
{
            ...
            if (this.workers.isEmpty())
            {
                ...
                this.workers.add(
                        new WorkerCfg(
                                ...
                                new EngineCfg(
                                        "com.intrbiz.bergamot.worker.engine.nagios.NagiosEngine", 
                                        new ExecutorCfg("com.intrbiz.bergamot.worker.engine.nagios.NagiosExecutor")
                                )
                        )
                );
                // nrpe engine
                this.workers.add(
                        new WorkerCfg(
                                ...
                                new EngineCfg(
                                        "com.intrbiz.bergamot.worker.engine.nagios.nrpe.NRPEEngine", 
                                        new ExecutorCfg("com.intrbiz.bergamot.worker.engine.nagios.nrpe.NRPEExecutor")
                                )
                        )
                );
            }
    ...
    public static BergamotDaemonCfg read(File file) throws JAXBException, IOException
    {
        return Configuration.read(BergamotDaemonCfg.class, new FileInputStream(file));
    }
}
