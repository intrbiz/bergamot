...
buildah config --author='Chris Ellis <chris@intrbiz.com>' --port 5701 --port 8090 --port 8081 --workingdir '/opt/bergamot/ui' --entrypoint '[ "/usr/bin/java", "-Dbootstrap.extract=false", "-jar", "bergamot-ui.app" ]' --cmd '[]' $ID
