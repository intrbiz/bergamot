...
buildah config --author='Chris Ellis <chris@intrbiz.com>' --port 15080 --port 8161 --workingdir '/opt/bergamot/worker' --entrypoint '[ "/usr/bin/java" ]' --cmd '[ "-Dbootstrap.extract=false", "-jar", "bergamot-worker.app" ]' $ID
