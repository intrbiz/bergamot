...
buildah config --author='Chris Ellis <chris@intrbiz.com>' --port 15080 --port 8161 --workingdir '/opt/bergamot/worker' --cmd '/usr/bin/java "-Djava.security.properties=/opt/bergamot/worker/java.security" "-Dbootstrap.extract=false" "-jar" "bergamot-worker.app"' $ID
