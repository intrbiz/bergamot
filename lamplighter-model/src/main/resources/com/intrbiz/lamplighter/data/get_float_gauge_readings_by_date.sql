CREATE OR REPLACE FUNCTION "lamplighter"."get_float_gauge_readings_by_date"("p_site_id" UUID, "p_reading_id" UUID, "p_start" TIMESTAMP WITH TIME ZONE, "p_end" TIMESTAMP WITH TIME ZONE, "p_rollup" BIGINT DEFAULT 300000, "p_agg" TEXT DEFAULT 'avg')
  ...
  v_query := $$ SELECT 
   ...
   LEFT JOIN ( 
    SELECT 
 	 ...
 	 $$ || quote_ident(p_agg) || $$("value")::REAL AS "value",
 	 $$ || quote_ident(p_agg) || $$("warning")::REAL AS "warning",
 	 $$ || quote_ident(p_agg) || $$("critical")::REAL AS "critical",
